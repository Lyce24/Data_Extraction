...
# of words and bi-grams. Each dictionary entry gives the list of words in 
# the text that follow that word/bi-gram (and possibly a count of the number 
# of times each follower does so). The code then generates random text based on 
# these statistics.
#
